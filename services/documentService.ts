...
// Setting the worker source directly from CDN to avoid 'Invalid URL' errors with import.meta.url
// This version matches the one specified in the index.html importmap
